                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="../interface/adminapp.php" class="mm-active">
                                            <i class="metismenu-icon"></i>
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>Aplicativos
                                    <div class="page-title-subheading">
                                        Vista de los aplicativos de expreso digital.
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <form id="frm-titulo" class="was-validated" method="post"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="form-text">Digite el titulo principal que desea mostrar
                                                        en el apartado de aplicativos.</div>
                                                </div>
                                            ...
                                            <form id="frm-subtitulo" class="was-validated" method="post"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="form-text">Digite el Subtitulo principal que desea
                                                        mostrar en el apartado de aplicativos.</div>
                                                </div>
                                                <div class="text-center">
                                            ...
                                            <form id="frm-descripcion" class="was-validated" method="post"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" rows="3"
                                                        placeholder="Digite la descripcion" name="descripcion"
                                                        id="descripcion" maxlength="300"  required></textarea>
