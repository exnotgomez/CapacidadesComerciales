...
<body>
    <div class="app-container app-theme-white body-tabs-shadow  fixed-header">
                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="../interface/adminindex.php" class="mm-active">
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>Index
                                    <div class="page-title-subheading">
                                        Vista inicial de expreso digital.
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="accordion" id="accordionExample">
                                            ...
                                            <form id="frm-titulo" class="was-validated" method="POST"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="content form-control"
                                                        ...
                                                        id="titulo_principal" maxlength="70" required>
                                        ...
                                        <div class="accordion-body">
                                            <form id="frm-subtitulo" class="was-validated" method="post"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="content form-control"
                                                        placeholder="Subtitulo principal" name="subtitulo"
                                                        id="subtitulo" maxlength="330" required>
                                ...
                                <div class="accordion-item">
                                    <div id="collapse3" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <form id="frm-img-principal" class="was-validated" method="post"
                                                enctype="multipart/form-data">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="form-text">Ingrese la imagen que desea mostrar.</div>
                                                </div>
                                                <div class="text-center">
                                ...
                                <div class="accordion-item">
                                    <div id="collapse4" class="accordion-collapse collapse"
                                        aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <form id="frm-img-secundaria" class="was-validated" method="post"
                                                enctype="multipart/form-data">
                                                <div class="mb-3">
                                                    <label class="title form-label">Imagen secundaria</label>
                                                    <input type="file" class="content form-control"
                                                        name="img-secundaria" id="img-secundaria" required>
                                                    <div class="form-text">Ingrese la imagen que desea mostrar.</div>
                                                </div>
                                                <div class="text-center">
                                                    <button type="submit" class="btn-enviar" name="btn-img-secundaria"
                                                        id="btn-img-secundaria">Enviar</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
        ...
        <script src="../../js/scripts/fuction_adminindex.js"></script>
