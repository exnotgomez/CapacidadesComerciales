                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="../add/addseccion.php" class="mm-active">
                                            <i class="metismenu-icon"></i>
                ...
                <div class="app-main__inner">
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>Crear Seccion
                                    <div class="page-title-subheading">
                                        Crear las secciones de expreso digital.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 seccion1">
                            <div class="card">
                                <div class="card-body">
                                    <form id="frm-seccion" class="row g-3 was-validated" method="post"
                                        ...
                                        <div class="ol-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <input type="text" class="form-control" name="seccion" id="seccion"
                                                required>
                                            <div class="form-text">Digite el nombre de la seccion que desea agregar.
                                            </div>
                                        </div>
                                        <div class="text-center">
                                            <button type="submit" class="btn-enviar" name="btn-seccion"
                                                id="btn-seccion">Enviar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
