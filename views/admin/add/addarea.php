                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="../add/addarea.php" class="mm-active">
                                            <i class="metismenu-icon"></i>
                ...
                <div class="app-main__inner">
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>Crear Area
                                    <div class="page-title-subheading">
                                        Crear las areas de expreso digital.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 seccion1">
                            <div class="card">
                                <div class="card-body">
                                    <form id="frm-area" class="row g-3 was-validated" method="post"
                                        enctype="multipart/form-data">
                                        <div class="ol-sm-12 col-md-12 col-lg-12">
                                            <label class="title form-label">Nombre del area</label>
                                            <input type="text" class="form-control" name="area"
                                                id="area" required>
                                            <div class="form-text">Digite el el nombre del area que desea agregar.
                                            </div>
                                        </div>
                                        <div class="text-center">
                                            <button type="submit" class="btn-enviar" name="btn-area"
                                                id="btn-area">Enviar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
