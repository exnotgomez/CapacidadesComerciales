                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="../add/addcargo.php" class="mm-active">
                                            <i class="metismenu-icon"></i>
                ...
                <div class="app-main__inner">
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>Crear Cargos
                                    <div class="page-title-subheading">
                                        Crear los cargos de expreso digital.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 seccion1">
                            <div class="card">
                                <div class="card-body">
                                    <form id="frm-cargo" class="row g-3 was-validated" method="post"
                                        enctype="multipart/form-data">
                                        <div class="ol-sm-12 col-md-12 col-lg-12">
                                            <label class="title form-label">Nombre del cargo</label>
                                            <input type="text" class="form-control" name="cargo" id="cargo" required>
                                            <div class="form-text">Digite el el nombre del cargo que desea agregar.
                                            </div>
                                        </div>
                                        <div class="text-center">
                                            <button type="submit" class="btn-enviar" name="btn-cargo"
                                                id="btn-cargo">Enviar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
