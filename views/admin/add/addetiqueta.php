                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="../add/addetiqueta.php" class="mm-active">
                                            <i class="metismenu-icon"></i>
                ...
                <div class="app-main__inner">
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>Crear Etiquetas
                                    <div class="page-title-subheading">
                                        Crear las etiquetas de expreso digital.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 seccion1">
                            <div class="card">
                                <div class="card-body">
                                    <form id="frm-etiqueta" class="row g-3 was-validated" method="post"
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <input type="text" class="form-control" name="etiqueta" id="etiqueta"
                                                required>
                                            <div class="form-text">Digite el el nombre de la etiqueta que desea agregar.
                                            </div>
                                        </div>
                                        <div class="text-center">
                                            <button type="submit" class="btn-enviar" name="btn-etiqueta"
                                                id="btn-etiqueta">Enviar</button>
                                        </div>
                                    </form>
