                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="../add/addapp.php" class="mm-active">
                                            <i class="metismenu-icon"></i>
                ...
                <div class="app-main__inner">
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>Crear App
                                    <div class="page-title-subheading">
                                        Crear las apps de expreso digital.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 seccion1">
                            <div class="card">
                                <div class="card-body">
                                    <form id="frm-app" class="row g-3 was-validated" method="post"
                                        ...
                                        <div class="ol-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="form-text">Digite el nombre del aplicativo que desea agregar.
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-lg-6">
                                            <label class="title form-label">Seccion</label>
                                            ...
                                            <div class="form-text">Elije la seccion a la que pertenece del aplicativo
                                                que desea agregar.
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-lg-6">
                                            <label class="title form-label">Tipo</label>
                                            <select class="form-select" name="tipo" id="tipo" required>
                                                <option value="">Selecciona</option>
                                                <option value="Principal">Principal</option>
                                                <option value="Secundaria">Secundaria</option>
                                            </select>
                                            <div class="form-text">Elije el tipo del aplicativo que desea agregar.
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-lg-6">
                                            <label class="title form-label">Url de la aplicacion</label>
                                            <input type="url" class="form-control" name="url" id="url" required>
                                            <div class="form-text">Digita la url del aplicativo que desea agregar</div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-lg-6">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn-enviar" name="btn-app"
                                                id="btn-app">Enviar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
