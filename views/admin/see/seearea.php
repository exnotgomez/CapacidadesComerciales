...
<body>
                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="../see/seearea.php" class="mm-active">
                                            <i class="metismenu-icon"></i>
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>Ver Areas
                                    <div class="page-title-subheading">
                                        Visualizar las areas de expreso digital.
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="table1" class="table table-hover" style="width:100%">
                                            ...
                                            <?php
                                            $consulta1 = "SELECT * FROM maestra_area ORDER BY id_area  DESC";
                                                ...
                                                <tr>
                                                    <td class="text-center">
                                                        <button class="edit" type="submit" data-bs-toggle="modal"
                                                            data-bs-target="#Modal<?php echo $p['id_area']; ?>"><i
                                                                class="fa-solid fa-pen-to-square fa-lg"></i>
                                                        </button>
                                                        <label>
                                                            <form id="frm-eliminar-area" method="post">
                                                                <input type="hidden" name="id" id="id"
                                                                    value="<?php echo $p['id_area']; ?>">
                                                                <button class="edit" type="submit" name="btn-eliminar-area"
                                                                    id="btn-elimnar-area<?php echo $i ?>"><i
    ...
    $i = 0;
    foreach ($consult1 as $p) { ?>
        <div class="modal fade" id="Modal<?php echo ($p['id_area']) ?>" tabindex="-1" aria-labelledby="Modal"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5"><i class="fa-solid fa-layer-group"></i>
                            Area
                            <?php echo $p['nombre']; ?>
                        </h1>
                    ...
                    <div class="modal-body">
                        <form id="frm-edit-area" class="row g-3 was-validated" method="post" enctype="multipart/form-data">
                            <input type="hidden" class="form-control" name="id" id="id"
                                value="<?php echo $p['id_area']; ?>">
                            <div class="col-12">
                                <label class="title form-label">Nombre del area</label>
                                <input type="text" class="form-control" name="area" id="area" required
                                    value="<?php echo $p['nombre']; ?>">
                            </div>
                            <div class="text-center">
                                <button type="submit" class="btn-enviar" name="btn-edit-area"
                                    id="btn-editar-area<?php echo $i ?>">Enviar</button>
                            </div>
                        </form>
                    </div>
                </div>
