...
<body>
                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="../see/seeetiqueta.php" class="mm-active">
                                            <i class="metismenu-icon"></i>
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>Ver Etiquetas
                                    <div class="page-title-subheading">
                                        Visualizar las etiquetas de expreso digital.
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="table1" class="table table-hover" style="width:100%">
                                            ...
                                            <?php
                                            $consulta1 = "SELECT * FROM maestra_etiqueta ORDER BY id_etiqueta  DESC";
                                            ...
                                            foreach ($consult1 as $p) {
                                                ...
                                                data-bs-target="#Modal' . ($p['id_etiqueta']) . '"><i class="fa-solid fa-pen-to-square fa-lg"></i></button> <label><form id="frm-eliminar-etiqueta" method="post">
                                                <input type="hidden" class="form-control" name="id" id="id" value="' . $p['id_etiqueta'] . '"><button class="edit" type="submit" name="btn-eliminar-etiqueta" id="btn-eliminar-etiqueta' . ($i) . '"><i class="fa-solid fa-trash"></i></button> </form></label></td>
                                                <td>' . $p['id_etiqueta'] . '</td>
                                                <td>' . $p['nombre'] . '</td>  '; ?>
                                                </tr>
                                                <?php $i++;
    ...
    $i = 0;
    foreach ($consult1 as $p) { ?>
        <div class="modal fade" id="Modal<?php echo ($p['id_etiqueta']) ?>" tabindex="-1" aria-labelledby="Modal"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5"><i class="fa-solid fa-tag"></i>
                            Etiqueta
                            <?php echo $p['nombre']; ?>
                        </h1>
                    ...
                    <div class="modal-body">
                        <form id="frm-edit-etiqueta" class="row g-3 was-validated" method="post"
                            enctype="multipart/form-data">
                            <input type="hidden" class="form-control" name="id" value="<?php echo $p['id_etiqueta']; ?>">
                            <div class="col-12">
                                <label class="title form-label">Nombre de la etiqueta</label>
                                <input type="text" class="form-control" name="etiqueta" required
                                    value="<?php echo $p['nombre']; ?>">
                            </div>
                            <div class="text-center">
                                <button type="submit" class="btn-enviar" name="btn-edit-etiqueta"
                                    id="btn-editar-etiqueta<?php echo $i ?>">Enviar</button>
                            </div>
                        </form>
                    </div>
                </div>
