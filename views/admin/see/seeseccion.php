...
<body>
                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="../see/seeseccion.php" class="mm-active">
                                            <i class="metismenu-icon"></i>
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>Ver Secciones
                                    <div class="page-title-subheading">
                                        Visualizar las secciones de expreso digital.
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="table1" class="table table-hover" style="width:100%">
                                            ...
                                            <?php
                                            $consulta1 = "SELECT * FROM maestra_seccion ORDER BY id_seccion  DESC";
                                            ...
                                            foreach ($consult1 as $p) {
                                                ...
                                                data-bs-target="#Modal' . ($p['id_seccion']) . '"><i class="fa-solid fa-pen-to-square fa-lg"></i></button> <label><form id="frm-eliminar-seccion" method="post">
                                                <input type="hidden" class="form-control" name="id" id="id" value="' . $p['id_seccion'] . '"><button class="edit" type="submit" name="btn-eliminar-seccion" id="btn-eliminar-seccion' . ($i) . '"><i class="fa-solid fa-trash"></i></button> </form></label></td>
                                                <td>' . $p['id_seccion'] . '</td>
    ...
    $i = 0;
    foreach ($consult1 as $p) { ?>
        <div class="modal fade" id="Modal<?php echo ($p['id_seccion']) ?>" tabindex="-1" aria-labelledby="Modal"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5"><i class="fa-solid fa-network-wired"></i>
                            Seccion
                            <?php echo $p['nombre_seccion']; ?>
                        </h1>
                    ...
                    <div class="modal-body">
                        <form id="frm-edit-seccion" class="row g-3 was-validated" method="post"
                            enctype="multipart/form-data">
                            <input type="hidden" class="form-control" name="id" value="<?php echo $p['id_seccion']; ?>">
                            <div class="col-12">
                                <label class="title form-label">Nombre de la seccion</label>
                                <input type="text" class="form-control" name="seccion" required
                                    value="<?php echo $p['nombre_seccion']; ?>">
                            </div>
                            <div class="text-center">
                                <button type="submit" class="btn-enviar" name="btn-edit-seccion"
                                    id="btn-editar-seccion<?php echo $i ?>">Enviar</button>
                            </div>
                        </form>
                    </div>
                </div>
